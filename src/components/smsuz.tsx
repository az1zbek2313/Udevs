...
import bgSmsuz from "@/../public/smsuzImage.png";
import smsLogo from "@/../public/smsuzIcon.svg";
import smsIcon from "@/../public/notificationIcon.svg";
      ...
      <div className={`${styles.container}`}>
        <div className={`${styles.flex} w-full `}>
          ...
          <div className="mb-[24px] ww:hidden block">
            <Image src={smsLogo} alt="delever logo" className="mb-[20px]" />
            <section className="bg-smsuzbg flex items-center gap-2 px-4 py-1 w-[130px] rounded-3xl">
              <Image src={smsIcon} alt="delivery icon" />
              <span className="text-smsuzcolor text-[14px]">Notification</span>
            </section>
          </div>
          ...
          <div className="flex flex-col justify-start  ww:w-[48%]">
            <div className="mb-[34px] hidden ww:block">
              <Image src={smsLogo} alt="delever logo" className="mb-[30px]" />
              <section className="bg-smsuzbg flex items-center gap-2 px-4 py-1 w-[156px] rounded-3xl">
                <Image src={smsIcon} alt="delivery icon" />
                <span className="text-smsuzcolor text-[14px]">
                  Notification
                </span>
              </section>
            </div>
